        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(ImageName))
                {
                    ...
                    ResizeCropImage.ResizeWithBackGroundColor(strFullPath, 190, 190, bgColor);
                    ResizeCropImage.CreateThumbNailByCondition("~/res/product/", "~/res/product/thumbs/", ImageName, 850,850);
