<%@ Page Title="" Language="C#" MasterPageFile="~/site-product.master" AutoEventWireup="true"
    CodeFile="meo-vat.aspx.cs" Inherits="san_pham" %>
            ...
            <asp:ListView ID="lstPromotion" runat="server" DataSourceID="odsPromotion" EnableModelValidation="True">
                <ItemTemplate>
                        <div class="product-box">
                            <a href='<%# progressTitle(Eval("ArticleTitle")) + "-mv-" + Eval("ArticleID") + ".aspx" %>'
                            ...
                            <div class="product-detail">
                                <h4 class="product-name"><a href='<%# progressTitle(Eval("ArticleTitle")) + "-mv-" + Eval("ArticleID") + ".aspx" %>'>
